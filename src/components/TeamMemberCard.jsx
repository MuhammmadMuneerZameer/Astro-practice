...
export default function TeamMemberCard({ member }) {
  ...
  return (
    <div className="relative w-full md:w-[30vw] mx-auto">
      ...
      {/* Modal / Popup */}
      {open && (
        <div className="absolute top-0 left-0 w-full z-20 bg-black bg-opacity-90 text-white p-6 rounded-lg transition-all duration-300 ease-in-out">
          <button
            onClick={() => setOpen(!open)}
          ...
          <div className="text-left flex flex-col justify-end">
            ...
            <div className="flex gap-4 mb-4">
              <a href={member.facebook} target="_blank" rel="noopener noreferrer" className="underline hover:text-green-400">
                facebook
              </a>
              <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="underline hover:text-green-400">
                linkedin
              </a>
            </div>
          </div>
